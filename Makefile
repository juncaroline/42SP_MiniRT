...
SRCS	:= $(addprefix $(SRCS_DIR), closest_hit.c error.c free.c init.c \
				...
				intersect_plane.c intersect_sphere.c intersect_utils.c light.c light_shadow.c \
				main.c math.c parse_elements.c parse_objects_add.c parse_objects.c parse.c \
				ray_direction.c ray_generator.c utils.c utils2.c \
